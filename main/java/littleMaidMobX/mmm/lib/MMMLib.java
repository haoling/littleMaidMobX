...
import littleMaidMobX.mmm.lib.debugs.EzRecipes;
import littleMaidMobX.mmm.lib.debugs.MMMDecorder;
import littleMaidMobX.mmm.lib.debugs.MoveWindow;
import littleMaidMobX.mmm.lib.destroyAll.DestroyAllManager;
import littleMaidMobX.mmm.lib.guns.GunsBase;
import littleMaidMobX.mmm.lib.multiModel.MMMLoader.MMMTransformer;
import littleMaidMobX.mmm.lib.multiModel.texture.MultiModelManager;
...
//	TODO ★		MMM_StabilizerManager.loadStabilizer();
			// テクスチャインデックスの構築
...
//		MultiModelManager.instance.execute();
	...
	public static void sendToClient(NetServerHandler pHandler, byte[] ldata) {
