...
public class MMM_TextureManager {
	...
	public void init() {
		...
		FileManager.getModFile("littleMaidMobX", "littleMaidMobX");
		...
		addSearch("littleMaidMobX", "/textures/entity/ModelMulti/", "ModelMulti_");
		addSearch("littleMaidMobX", "/textures/entity/littleMaid/", "ModelMulti_");
		addSearch("littleMaidMobX", "/textures/entity/littleMaid/", "ModelLittleMaid_");
...
//		int li = textureServerIndex.get(getDefaultTexture(pEntity));
	...
	protected void reciveFromClientGetTexturePackIndex(NetServerHandler pHandler, byte[] pData) {
		...
		MMMLib.sendToClient(pHandler, ldata);
	}
