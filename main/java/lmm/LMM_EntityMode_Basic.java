...
//		ltasks[0].addTask(8, owner.aiOpenDoor);
		...
		ltasks[0].addTask(12, new EntityAIWatchClosest2(owner, lmm.EntityLivingBase.class, 10F, 0.02F));
		ltasks[0].addTask(13, new EntityAIWatchClosest2(owner, lmm.LMM_EntityLittleMaid.class, 10F, 0.02F));
		ltasks[0].addTask(13, new EntityAIWatchClosest2(owner, lmm.EntityPlayer.class, 10F, 0.02F));
