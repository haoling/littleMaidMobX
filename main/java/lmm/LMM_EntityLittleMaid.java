...
import static lmm.LMM_Statics.dataWatch_Absoption;
import static lmm.LMM_Statics.dataWatch_Color;
import static lmm.LMM_Statics.dataWatch_DominamtArm;
import static lmm.LMM_Statics.dataWatch_ExpValue;
import static lmm.LMM_Statics.dataWatch_Flags;
import static lmm.LMM_Statics.dataWatch_Flags_Aimebow;
import static lmm.LMM_Statics.dataWatch_Flags_Bloodsuck;
import static lmm.LMM_Statics.dataWatch_Flags_Freedom;
import static lmm.LMM_Statics.dataWatch_Flags_LooksSugar;
import static lmm.LMM_Statics.dataWatch_Flags_OverDrive;
import static lmm.LMM_Statics.dataWatch_Flags_Tracer;
import static lmm.LMM_Statics.dataWatch_Flags_Wait;
import static lmm.LMM_Statics.dataWatch_Flags_Working;
import static lmm.LMM_Statics.dataWatch_Flags_looksWithInterest;
import static lmm.LMM_Statics.dataWatch_Flags_looksWithInterestAXIS;
import static lmm.LMM_Statics.dataWatch_Flags_remainsContract;
import static lmm.LMM_Statics.dataWatch_Free;
import static lmm.LMM_Statics.dataWatch_Gotcha;
import static lmm.LMM_Statics.dataWatch_ItemUse;
import static lmm.LMM_Statics.dataWatch_Mode;
import static lmm.LMM_Statics.dataWatch_Parts;
import static lmm.LMM_Statics.dataWatch_Texture;
...
//		ltasks[0].addTask(8, aiPanic);
		...
		// 首の動き単独
		ltasks[0].addTask(51, new EntityAIWatchClosest(this, lmm.EntityLivingBase.class, 10F));
