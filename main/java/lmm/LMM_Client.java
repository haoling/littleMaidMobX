...
import static lmm.LMM_Statics.LMN_Client_PlaySound;
import static lmm.LMM_Statics.LMN_Client_SetIFFValue;
import static lmm.LMM_Statics.LMN_Client_SwingArm;
...
public class LMM_Client {
	...
	public static void addRenderer(Map map) {
		map.put(lmm.LMM_EntityLittleMaid.class, new LMM_RenderLittleMaid(0.3F));
	}
